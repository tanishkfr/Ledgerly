...
export const VelocityChart: React.FC<VelocityChartProps> = ({ data, viewMode = 'TOTAL_VOLUME' }) => {
  ...
  useEffect(() => {
    // Mount Guard: Delay rendering until parent dimensions are stable
  ...
  if (!isMounted) {
      return (
          <div className="w-full h-full min-h-[300px] bg-neutral-900/10 rounded-lg flex items-center justify-center">
  ...
  return (
    ...
    <div className="w-full h-full min-h-[300px] relative">
        {/* 99% Width/Height Buffer to prevent 0px collapse */}
